...
export default function EmployeeOrderListItem({ id, car_img, car_name, status, price, created_on, order_placer }) {
    const navigate = useNavigate()

    const handleClick = () => {
        navigate('/employee_order/' + id)
    }
        ...
        >
            <div className="flex items-center gap-4 p-4">
                ...
                <div className="flex flex-col text-sm text-gray-700">
                    ...
                    <p><span className="font-medium text-gray-600">Price:</span> ${price}</p>
                    <p><span className="font-medium text-gray-600">Created:</span> {created_on}</p>
